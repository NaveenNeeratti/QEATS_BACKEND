...
public class RestaurantServiceImpl implements RestaurantService {
  ...
  public GetRestaurantsResponse findAllRestaurantsCloseBy(
      GetRestaurantsRequest getRestaurantsRequest, LocalTime currentTime) {
        ...
        // LocalTime peakStart = LocalTime.of(19,0);
        // LocalTime peakEnd = LocalTime.of(0,0);
        if((currentTime.isAfter(LocalTime.of(7,59)) && currentTime.isBefore(LocalTime.of(10,1))) || (currentTime.isAfter(LocalTime.of(12,59)) && currentTime.isBefore(LocalTime.of(14,1))) || (currentTime.isAfter(LocalTime.of(18,59)) && currentTime.isBefore(LocalTime.of(21,1))) ){
