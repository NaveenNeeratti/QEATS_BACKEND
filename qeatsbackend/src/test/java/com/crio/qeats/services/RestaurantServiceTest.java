...
class RestaurantServiceTest {
  ...
  private String getServingRadiusPeakHours(List<Restaurant> restaurants, LocalTime timeOfService) {
  ...
  private String getServingRadiusNormalHours(List<Restaurant> restaurants, LocalTime timeOfService) {
    when(restaurantRepositoryServiceMock
        .findAllRestaurantsCloseBy(any(Double.class), any(Double.class), any(LocalTime.class),
            any(Double.class)))
        .thenReturn(restaurants);
  ...
  void peakHourServingRadiusOf3KmsAt7Pm() throws IOException {
    assertEquals("3.0",getServingRadiusPeakHours(loadRestaurantsDuringPeakHours(), LocalTime.of(19, 0)));
  }
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    ...
    assertEquals("5.0",getServingRadiusNormalHours(loadRestaurantsDuringNormalHours(),LocalTime.of(8,0)));
  }
